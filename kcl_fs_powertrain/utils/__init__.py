...
This package provides utility modules for constants, plotting, validation,
and track processing used throughout the Formula Student powertrain simulation project.
"""
...
from .constants import (
    ...
    # Enumerations (Ensure core simulator enums are imported from core)
    # from ..core.simulator import EventType # If EventType is needed here
...
# Import track utility functions
from .track_utils import (
    preprocess_track_points, ensure_unique_values
)
